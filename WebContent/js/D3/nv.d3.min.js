...
(function() {
	...
	e.log = function() {
		...
		else if (e.dev && typeof console.log == "function"
	...
	e.render = function(n) {
		...
		setTimeout(function() {
			...
			for (var i = 0; i < n && (r = e.render.queue[i]); i++) {
				t = r.generate();
				if (typeof r.callback == typeof Function)
					r.callback(t);
				e.graphs.push(t)
			}
			e.render.queue.splice(0, i);
			if (e.render.queue.length)
	...
	e.interactiveGuideline = function() {
			...
			o
					.each(function(o) {
						...
						var v = h
								...
								.data([ o ]);
						var m = v.enter().append("g").attr("class",
								" nv-wrap nv-interactiveLineLayer");
						m.append("g").attr("class", "nv-interactiveGuideLine");
						if (!f) {
							return
						}
						f.on("mousemove", g, true).on("mouseout", g, true).on(
								"dblclick", g);
						c.renderGuideLine = function(t) {
							...
							var n = v
									...
									.selectAll("line")
									.data(
											t != null ? [ e.utils.NaNtoZero(t) ]
													: [], String);
							n.enter().append("line").attr("class",
									"nv-guideline").attr("x1", function(e) {
								return e
							}).attr("x2", function(e) {
								return e
							}).attr("y1", d).attr("y2", 0);
		...
		var n = null, r = null, i = {
			left : 0,
			top : 0
		}, s = d3.scale.linear(), o = d3.scale.linear(), u = d3.dispatch(
				"elementMousemove", "elementMouseout", "elementDblclick"), a = true, f = null;
	...
	(function() {
		...
		window.nv.models.tooltip = function() {
			...
			function b(e) {
				...
				if (n.node() === null) {
					n = t.append("div").attr("class",
							"nvtooltip " + (u ? u : "xy-tooltip"))
							.attr("id", h)
				}
				n.node().innerHTML = e;
			...
			function w() {
				...
				if (a) {
					...
					var d = p ? p.getBoundingClientRect() : a
			...
			var t = null, n = null, r = "n", i = 130, s = 200, o = null, u = null, a = null, f = null, l = {
				left : null,
				top : null
			}, c = true, h = "nvtooltip-" + Math.floor(Math.random() * 1e5);
			...
			var m = function(e) {
				...
				var r = n.selectAll("thead").data([ e ]).enter()
						.append("thead");
				r.append("tr").append("td").attr("colspan", 3).append("strong")
						.classed("x-value", true).html(v(e.value));
				var i = n.selectAll("tbody").data([ e ]).enter()
						.append("tbody");
				...
				s.append("td").classed("legend-color-guide", true)
						.append("div").style("background-color", function(e) {
							return e.color
						});
				...
				s.selectAll("td").each(
						function(e) {
							if (e.highlight) {
								var t = d3.scale.linear().domain([ 0, 1 ])
										.range([ "#fff", e.color ]);
								var n = .6;
								d3.select(this).style("border-bottom-color",
										t(n)).style("border-top-color", t(n))
							}
						});
				var o = n.node().outerHTML;
				if (e.footer !== undefined)
					o += "<div class='footer'>" + e.footer + "</div>";
				return o
			};
			var g = function(e) {
				if (e && e.series && e.series.length > 0)
					return true;
				return false
			};
		...
		e.tooltip.calcTooltipPosition = function(t, n, r, i) {
			var s = parseInt(i.offsetHeight), o = parseInt(i.offsetWidth), u = e.utils
					.windowSize().width, a = e.utils.windowSize().height, f = window.pageYOffset, l = window.pageXOffset, c, h;
	...
	e.utils.customTheme = function(e, t, n) {
		...
		return function(i, s) {
			...
			if (typeof e[o] !== "undefined")
				return typeof e[o] === "function" ? e[o]() : e[o];
			else
				return n[--r]
		}
	};
	...
	e.utils.NaNtoZero = function(e) {
		if (typeof e !== "number" || isNaN(e) || e === null || e === Infinity)
			return 0;
		return e
	};
	...
	e.models.axis = function() {
		...
		function m(e) {
			e
					.each(function(e) {
						...
						var g = m.enter().append("g").attr("class",
								"nvd3 nv-wrap nv-axis");
						var y = g.append("g");
						var b = m.select("g");
						if (p !== null)
							t.ticks(p);
						else if (t.orient() == "top" || t.orient() == "bottom")
							t
									.ticks(Math
											.abs(s.range()[1] - s.range()[0]) / 100);
						b.transition().call(t);
						v = v || t.scale();
						var w = t.tickFormat();
						if (w == null) {
						...
						var E = b.selectAll("text.nv-axislabel").data(
								[ o || null ]);
						E.exit().remove();
						switch (t.orient()) {
						case "top":
							E.enter().append("text").attr("class",
									"nv-axislabel");
							var S = s.range().length == 2 ? s.range()[1] : s
									.range()[s.range().length - 1]
									+ (s.range()[1] - s.range()[0]);
							E.attr("text-anchor", "middle").attr("y", 0).attr(
									"x", S / 2);
							if (u) {
								...
								}).select("text").attr("dy", "-0.5em").attr(
										"y", -t.tickPadding()).attr(
						...
						case "bottom":
							...
							var S = s.range().length == 2 ? s.range()[1] : s
									.range()[s.range().length - 1]
									+ (s.range()[1] - s.range()[0]);
							E.attr("text-anchor", "middle").attr("y", T).attr(
									"x", S / 2);
							if (u) {
								var x = m
										...
										function(e, t) {
											return "translate("
													+ (s(e) + (h ? s
															.rangeBand() / 2
															: 0)) + ",0)"
										}).select("text").attr("dy", ".71em")
										.attr("y", t.tickPadding()).attr(
												"transform",
												function(e, t, n) {
													return "rotate(" + f
															+ " 0,0)"
						...
						case "right":
							E.enter().append("text").attr("class",
									"nv-axislabel");
							E.style("text-anchor", l ? "middle" : "begin")
									.attr("transform", l ? "rotate(90)" : "")
									.attr(
											"y",
											l ? -Math.max(n.right, r) + 12
													: -10).attr(
											"x",
											l ? s.range()[0] / 2 : t
													.tickPadding());
							if (u) {
								var x = m.selectAll("g.nv-axisMaxMin").data(
										s.domain());
								x.enter().append("g").attr("class",
										"nv-axisMaxMin").append("text").style(
										"opacity", 0);
								x.exit().remove();
								x.attr("transform", function(e, t) {
									return "translate(0," + s(e) + ")"
								}).select("text").attr("dy", ".32em").attr("y",
										0).attr("x", t.tickPadding()).style(
						...
						case "left":
							E.enter().append("text").attr("class",
									"nv-axislabel");
							E.style("text-anchor", l ? "middle" : "end").attr(
									"transform", l ? "rotate(-90)" : "").attr(
									"y", l ? -Math.max(n.left, r) + d : -10)
									.attr(
											"x",
											l ? -s.range()[0] / 2 : -t
													.tickPadding());
						...
						if (u
							...
							if (s.domain()[0] == s.domain()[1]
									&& s.domain()[0] == 0)
								m.selectAll("g.nv-axisMaxMin").style("opacity",
										function(e, t) {
											return !t ? 1 : 0
										})
						}
						if (u
								&& (t.orient() === "top" || t.orient() === "bottom")) {
							var L = [];
							m.selectAll("g.nv-axisMaxMin").each(
									function(e, t) {
										try {
											if (t)
												L.push(s(e)
						...
						if (a)
							b.selectAll(".tick").filter(
									function(e) {
										return !parseFloat(Math
												.round(e.__data__ * 1e5) / 1e6)
												&& e.__data__ !== undefined
									}).classed("zero", true);
						v = s.copy()
					});
			return m
		...
		var n = {
			...
			bottom : 0,
			left : 0
		}, r = 55, i = 60, s = d3.scale.linear(), o = null, u = true, a = true, f = 0, l = true, c = false, h = false, p = null, d = 12;
		t.scale(s).orient("bottom").tickFormat(function(e) {
			return e
		});
		var v;
		m.axis = t;
		d3.rebind(m, t, "orient", "tickValues", "tickSubdivide", "tickSize",
	...
	e.models.legend = function() {
		...
		function c(h) {
			h.each(function(c) {
				var h = n - t.left - t.right, p = d3.select(this);
				var d = p.selectAll("g.nv-legend").data([ c ]);
				var v = d.enter().append("g").attr("class", "nvd3 nv-legend")
						.append("g");
				var m = d.select("g");
				...
				var y = g.enter().append("g").attr("class", "nv-series").on(
				...
				y.append("circle").style("stroke-width", 2).attr("class",
						"nv-legend-symbol").attr("r", 5);
				y.append("text").attr("text-anchor", "start").attr("class",
						"nv-legend-text").attr("dy", ".32em").attr("dx", "8");
				...
				if (o) {
					...
					g.attr("transform", function(e, t) {
						return "translate(" + T[t % w] + ","
								+ (5 + Math.floor(t / w) * 20) + ")"
					});
					if (u) {
						m.attr("transform", "translate(" + (n - t.right - E)
								+ "," + t.top + ")")
					} else {
					...
					g.attr("transform", function(e, r) {
						var i = d3.select(this).select("text").node()
					...
					m.attr("transform", "translate(" + (n - t.right - A) + ","
							+ t.top + ")");
		...
		var t = {
			...
			return e.key
		}, s = e.utils.defaultColor(), o = true, u = false, a = true, f = false, l = d3
				.dispatch("legendClick", "legendDblclick", "legendMouseover",
	...
	e.models.scatter = function() {
			...
			q
					.each(function(I) {
						function Q() {
							...
							if (D === true) {
								if (x) {
									var a = X.select("defs").selectAll(
											".nv-point-clips").data([ s ])
											.enter();
									a.append("clipPath").attr("class",
											"nv-point-clips").attr("id",
											"nv-points-clip-" + s);
									var c = X.select("#nv-points-clip-" + s)
									...
									X.select(".nv-point-paths").attr(
											"clip-path",
											"url(#nv-points-clip-" + s + ")")
								}
								if (i.length) {
									i.push([ o.range()[0] - 20,
											u.range()[0] - 20, null, null ]);
									i.push([ o.range()[1] + 20,
											u.range()[1] + 20, null, null ]);
									i.push([ o.range()[0] - 20,
											u.range()[0] + 20, null, null ]);
									i.push([ o.range()[1] + 20,
											u.range()[1] - 20, null, null ])
								}
								var h = d3.geom.polygon([ [ -10, -10 ],
										[ -10, r + 10 ], [ n + 10, r + 10 ],
										[ n + 10, -10 ] ]);
								...
								var d = X.select(".nv-point-paths").selectAll(
										"path").data(p);
								d.enter().append("path").attr("class",
										function(e, t) {
											return "nv-path-" + t
										});
								d.exit().remove();
						...
						var q = n - t.left - t.right, R = r - t.top - t.bottom, U = d3
								.select(this);
						...
						var V = X.enter().append("g").attr(
								"class",
								"nvd3 nv-wrap nv-scatter nv-chart-" + s
										+ (M ? " nv-single-point" : ""));
						var $ = V.append("defs");
						var J = V.append("g");
						var K = X.select("g");
						...
						X.attr("transform", "translate(" + t.left + "," + t.top
								+ ")");
						$.append("clipPath").attr("id", "nv-edge-clip-" + s)
								.append("rect");
						X.select("#nv-edge-clip-" + s + " rect").attr("width",
								q).attr("height", R > 0 ? R : 0);
						K.attr("clip-path", S ? "url(#nv-edge-clip-" + s + ")"
								: "");
						F = true;
						var G = X.select(".nv-groups").selectAll(".nv-group")
								.data(function(e) {
									return e
								}, function(e) {
									return e.key
								});
						G.enter().append("g").style("stroke-opacity", 1e-6)
						...
						if (p) {
							var Y = G.selectAll("circle.nv-point").data(
									function(e) {
										return e.values
									}, y);
							Y.enter().append("circle").style("fill",
									function(e, t) {
										return e.color
									}).style("stroke", function(e, t) {
								return e.color
							...
							Y.exit().remove();
							G.exit().selectAll("path.nv-point").transition()
									.attr("cx", function(t, n) {
							...
							Y.each(function(e, t) {
								d3.select(this).classed("nv-point", true)
										.classed("nv-point-" + t, true)
										.classed("hover", false)
							});
							...
							var Y = G.selectAll("path.nv-point").data(
									function(e) {
										return e.values
									});
							Y.enter().append("path").style("fill",
									function(e, t) {
										return e.color
									}).style("stroke", function(e, t) {
								return e.color
									...
									"transform",
									function(e, t) {
										return "translate(" + P(f(e, t)) + ","
												+ H(l(e, t)) + ")"
									}).attr(
									"d",
									d3.svg.symbol().type(h).size(
											function(e, t) {
												return a(c(e, t))
											}));
							Y.exit().remove();
		...
		var t = {
			...
			bottom : 0,
			left : 0
		}, n = 960, r = 500, i = e.utils.defaultColor(), s = Math.floor(Math
				.random() * 1e5), o = d3.scale.linear(), u = d3.scale.linear(), a = d3.scale
				.linear(), f = function(e) {
			return e.x
		}, l = function(e) {
			return e.y
		...
		}, p = true, d = [], v = [], m = [], g = true, y = null, b = function(e) {
			return !e.notActive
		}, w = false, E = .1, S = false, x = true, T = function() {
			return 25
		}, N = null, C = null, k = null, L = null, A = null, O = null, M = false, _ = d3
				.dispatch("elementClick", "elementMouseover", "elementMouseout"), D = true;
		var P, H, B, j, F = false;
		I.clearHighlights = function() {
			d3.selectAll(".nv-chart-" + s + " .nv-point.hover").classed(
					"hover", false)
		};
		I.highlightPoint = function(e, t, n) {
			d3
					.select(
							".nv-chart-" + s + " .nv-series-" + e
									+ " .nv-point-" + t).classed("hover", n)
		};
		_.on("elementMouseover.point", function(e) {
			if (g)
				I.highlightPoint(e.seriesIndex, e.pointIndex, true)
		});
		_.on("elementMouseout.point", function(e) {
			if (g)
				I.highlightPoint(e.seriesIndex, e.pointIndex, false)
		});
		I.dispatch = _;
	...
	e.models.line = function() {
		...
		function m(g) {
			g.each(function(m) {
				var g = r - n.left - n.right, b = i - n.top - n.bottom, w = d3
						.select(this);
				c = t.xScale();
				h = t.yScale();
				d = d || c;
				...
				var S = E.enter().append("g").attr("class",
						"nvd3 nv-wrap nv-line");
				var T = S.append("defs");
				var N = S.append("g");
				var C = E.select("g");
				...
				k.transition().call(t);
				T.append("clipPath").attr("id", "nv-edge-clip-" + t.id())
						.append("rect");
				E.select("#nv-edge-clip-" + t.id() + " rect").attr("width", g)
						.attr("height", b > 0 ? b : 0);
				C.attr("clip-path", l ? "url(#nv-edge-clip-" + t.id() + ")"
						: "");
				k.attr("clip-path", l ? "url(#nv-edge-clip-" + t.id() + ")"
						: "");
				var L = E.select(".nv-groups").selectAll(".nv-group").data(
						function(e) {
							return e
						}, function(e) {
							return e.key
						});
				L.enter().append("g").style("stroke-opacity", 1e-6).style(
						"fill-opacity", 1e-6);
				L.exit().remove();
				...
				L.transition().style("stroke-opacity", 1).style("fill-opacity",
						.5);
				...
				A.enter().append("path").attr("class", "nv-area").attr(
						"d",
						function(t) {
							return d3.svg.area().interpolate(p).defined(a).x(
									function(t, n) {
				...
				O.enter().append("path").attr("class", "nv-line").attr(
						"d",
						d3.svg.line().interpolate(p).defined(a).x(
								function(t, n) {
									return e.utils.NaNtoZero(d(o(t, n)))
								}).y(function(t, n) {
							return e.utils.NaNtoZero(v(u(t, n)))
		...
		var n = {
			...
			return e.area
		}, l = false, c, h, p = "linear";
		t.size(16).sizeDomain([ 16, 256 ]);
		var d, v;
		m.dispatch = t.dispatch;
		m.scatter = t;
		d3.rebind(m, t, "id", "interactive", "size", "xScale", "yScale",
	...
	e.models.lineChart = function() {
		...
		function N(m) {
			m
					.each(function(m) {
						var C = d3.select(this), k = this;
						var L = (a || parseInt(C.style("width")) || 960)
								- o.left - o.right, A = (f
								|| parseInt(C.style("height")) || 400)
								- o.top - o.bottom;
						N.update = function() {
						...
						if (!m || !m.length || !m.filter(function(e) {
							...
							M.enter().append("text").attr("class",
									"nvd3 nv-noData").attr("dy", "-.7em")
									.style("text-anchor", "middle");
							M.attr("x", o.left + L / 2)
									.attr("y", o.top + A / 2).text(function(e) {
										return e
									});
							return N
						} else {
						...
						g = t.xScale();
						y = t.yScale();
						var _ = C.selectAll("g.nv-wrap.nv-lineChart").data(
								[ m ]);
						var D = _.enter().append("g").attr("class",
								"nvd3 nv-wrap nv-lineChart").append("g");
						var P = _.select("g");
						...
						P.select("rect").attr("width", L).attr("height",
								A > 0 ? A : 0);
						if (l) {
							i.width(L);
							...
							if (o.top != i.height()) {
								o.top = i.height();
								A = (f || parseInt(C.style("height")) || 400)
										- o.top - o.bottom
							}
							_.select(".nv-legendWrap").attr("transform",
									"translate(0," + -o.top + ")")
						}
						_.attr("transform", "translate(" + o.left + "," + o.top
								+ ")");
						if (p) {
							P.select(".nv-y.nv-axis").attr("transform",
									"translate(" + L + ",0)")
						}
						if (d) {
						...
						var H = P.select(".nv-linesWrap").datum(
								m.filter(function(e) {
									return !e.disabled
								}));
						H.transition().call(t);
						if (c) {
							...
							P.select(".nv-x.nv-axis").attr("transform",
						...
						s.dispatch.on("elementMousemove", function(i) {
							...
							m.filter(function(e, t) {
								...
								return !e.disabled
									...
									function(n, r) {
										f = e.interactiveBisect(n.values,
												i.pointXValue, N.x());
										if (r == 0) {
											publicPosition = f
										}
							...
							s.tooltip.position({
								left : l + o.left,
								top : i.mouseY + o.top
							}).chartContainer(k.parentNode).enabled(v)
		...
		var t = e.models.line(), n = e.models.axis(), r = e.models.axis(), i = e.models
				.legend(), s = e.interactiveGuideline();
		var o = {
			top : 7,
			right : 13,
			bottom : 7,
			left : 0
		}, u = e.utils.defaultColor(), a = null, f = null, l = true, c = true, h = true, p = false, d = false, v = true, m = function(
				e, t, n, r, i) {
			return "<h3>" + e + "</h3>" + "<p>" + n + " at " + t + "</p>"
		}, g, y, b = {}, w = null, E = "No Data Available.", S = d3.dispatch(
				"tooltipShow", "tooltipHide", "stateChange", "changeState"), x = 250;
		n.orient("bottom").tickPadding(7);
		r.orient(p ? "right" : "left");
		var T = function(i, s) {
			var o = i.pos[0] + (s.offsetLeft || 0), u = i.pos[1]
					+ (s.offsetTop || 0), a = n.tickFormat()(
					t.x()(i.point, i.pointIndex)), f = r.tickFormat()(
					t.y()(i.point, i.pointIndex)), l = m(i.series.key, a, f, i,
					N);
		...
		d3.rebind(N, t, "defined", "isArea", "x", "y", "size", "xScale",
				"yScale", "xDomain", "yDomain", "xRange", "yRange", "forceX",
				"forceY", "interactive", "clipEdge", "clipVoronoi",
				"useVoronoi", "id", "interpolate");
	...
	e.models.pie = function() {
		...
		function S(e) {
			e
					.each(function(e) {
						function q(e) {
							var t = (e.startAngle + e.endAngle) * 90 / Math.PI
									- 90;
							return t > 90 ? t - 180 : t
						}
						function R(e) {
							e.endAngle = isNaN(e.endAngle) ? 0 : e.endAngle;
							e.startAngle = isNaN(e.startAngle) ? 0
									: e.startAngle;
							if (!m)
								e.innerRadius = 0;
						...
						var o = n - t.left - t.right, f = r - t.top - t.bottom, S = Math
								.min(o, f) / 2, x = .85 * S, T = d3
								.select(this);
						var N = T.selectAll(".nv-wrap.nv-pie").data(e);
						var C = N.enter().append("g").attr("class",
								"nvd3 nv-wrap nv-pie nv-chart-" + u);
						var k = C.append("g");
						var L = N.select("g");
						...
						N.attr("transform", "translate(" + t.left + "," + t.top
								+ ")");
						L.select(".nv-pie").attr("transform",
								"translate(" + o / 2 + "," + f / 2 + ")");
						L.select(".nv-pieLabels").attr("transform",
								"translate(" + o / 2 + "," + f / 2 + ")");
						...
						var M = N.select(".nv-pie").selectAll(".nv-slice")
								.data(O);
						var _ = N.select(".nv-pieLabels")
								.selectAll(".nv-label").data(O);
						M.exit().remove();
						_.exit().remove();
						var D = M.enter().append("g").attr("class", "nv-slice")
								.on(
										"mouseover",
										function(e, t) {
						...
						M.select("path").transition().attr("d", A).attrTween(
								"d", R);
						if (l) {
									...
									.each(
											function(e, t) {
												...
												n
														...
														.style(
																"text-anchor",
																g ? (e.startAngle + e.endAngle) / 2 < Math.PI ? "start"
																		: "end"
																		: "middle")
														.style("fill", "#000")
											});
							...
							_
									...
									.style(
											"text-anchor",
											g ? (d.startAngle + d.endAngle) / 2 < Math.PI ? "start"
													: "end"
													: "middle")
									.text(
											function(e, t) {
												var n = (e.endAngle - e.startAngle)
														/ (2 * Math.PI);
												var r = {
													key : i(e.data),
													value : s(e.data),
		...
		var t = {
			...
			bottom : 0,
			left : 0
		}, n = 250, r = 500, i = function(e) {
			return e.x
		}, s = function(e) {
			return e.y
		}, o = function(e) {
			return e.description
		}, u = Math.floor(Math.random() * 1e4), a = e.utils.defaultColor(), f = d3
				.format(",.2f"), l = true, c = true, h = false, p = "key", v = .02, m = false, g = false, y = false, b = false, w = .5, E = d3
				.dispatch("chartClick", "elementClick", "elementDblClick",
	...
	e.models.pieChart = function() {
		...
		function v(e) {
			e
					.each(function(e) {
						var u = d3.select(this), a = this;
						var f = (i || parseInt(u.style("width")) || 960)
								- r.left - r.right, d = (s
								|| parseInt(u.style("height")) || 400)
								- r.top - r.bottom;
						v.update = function() {
							u.transition().call(v)
						};
						...
						if (!e || !e.length) {
							...
							g.enter().append("text").attr("class",
									"nvd3 nv-noData").attr("dy", "-.7em")
									.style("text-anchor", "middle");
							g.attr("x", r.left + f / 2)
									.attr("y", r.top + d / 2).text(function(e) {
										return e
									});
							return v
						} else {
						...
						var y = u.selectAll("g.nv-wrap.nv-pieChart")
								.data([ e ]);
						var b = y.enter().append("g").attr("class",
								"nvd3 nv-wrap nv-pieChart").append("g");
						var w = y.select("g");
						...
						if (o) {
							...
							if (r.top != n.height()) {
								r.top = n.height();
								d = (s || parseInt(u.style("height")) || 400)
										- r.top - r.bottom
							}
						}
						y
								...
								.attr(
										...
										"translate(0,"
												+ (.5 * parseInt(u
														.style("height")) - .5 * parseInt(u
														.style("width"))) + ")");
						t.width(parseInt(u.style("width"))).height(
								parseInt(u.style("height")));
		...
		var t = e.models.pie(), n = e.models.legend();
		var r = {
			top : 0,
			right : 0,
			bottom : 0,
			left : 0
		}, i = null, s = null, o = true, u = e.utils.defaultColor(), a = true, f = function(
				e, t, n, r) {
			return "<h3>" + e + "</h3>" + "<p>" + t + "</p>"
		}, l = {}, c = null, h = "No Data Available.", p = d3.dispatch(
				"tooltipShow", "tooltipHide", "stateChange", "changeState");
		var d = function(n, r) {
			var i = t.description()(n.point) || t.x()(n.point);
			var s = n.pos[0] + (r && r.offsetLeft || 0), o = n.pos[1]
					+ (r && r.offsetTop || 0), u = t.valueFormat()(
					t.y()(n.point)), a = f(i, u, n, v);
		...
		v.dispatch = p;
		v.pie = t;
		d3.rebind(v, t, "valueFormat", "values", "x", "y", "description", "id",
				"showLabels", "donutLabelsOutside", "pieLabelsOutside",
				"labelType", "donut", "donutRatio", "labelThreshold");

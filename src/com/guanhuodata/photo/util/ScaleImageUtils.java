...
public class ScaleImageUtils {
    ...
    private static final String DEFAULT_FILE_PATH = "d://resizeImage//temp-";
    ...
    public static void main(String[] args) throws ImageFormatException, MalformedURLException, IOException {
        ...
        //System.err.println(resize(100, 100, ImageQuality.medium.getQuality(), null, ImageIO.read(new File("d://img//99大促盛典爆发_单品页_无线640_LF106.jpg"))));
    	File file = new File("d://img//99大促盛典爆发_单品页_无线640_LF106.jpg");
